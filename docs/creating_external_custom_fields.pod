...
Set(@CustomFieldValuesSources, "RT::Model::CustomFieldValues::MySource");
...
You have to implement a subclass of L<RT::Model::CustomFieldValues::External>.
...
Here's a simple static example:
  ...
  package RT::Model::CustomFieldValues::MySource;
