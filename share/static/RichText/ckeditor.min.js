...
CKEDITOR.config.clipboard_notificationDuration=1E4;CKEDITOR.plugins.add("resize",{init:function(b){function f(d){var e=c.width,m=c.height,f=e+(d.data.$.screenX-n.x)*("rtl"==g?-1:1);d=m+(d.data.$.screenY-n.y);h&&(e=Math.max(a.resize_minWidth,Math.min(f,a.resize_maxWidth)));p&&(m=Math.max(a.resize_minHeight,Math.min(d,a.resize_maxHeight)));b.resize(h?e:null,m)}function k(){CKEDITOR.document.removeListener("mousemove",f);CKEDITOR.document.removeListener("mouseup",k);b.document&&(b.document.removeListener("mousemove",f),b.document.removeListener("mouseup",
...
CKEDITOR.config.entities_additional="#39";(function(){CKEDITOR.plugins.add("panel",{beforeInit:function(a){a.ui.addHandler(CKEDITOR.UI_PANEL,CKEDITOR.ui.panel.handler)}});CKEDITOR.UI_PANEL="panel";CKEDITOR.ui.panel=function(a,b){b&&CKEDITOR.tools.extend(this,b);CKEDITOR.tools.extend(this,{className:"",css:[]});this.id=CKEDITOR.tools.getNextId();this.document=a;this.isFramed=this.forceIFrame||this.css.length;this._={blocks:{}}};CKEDITOR.ui.panel.handler={create:function(a){return new CKEDITOR.ui.panel(a)}};var g=CKEDITOR.addTemplate("panel",
...
CKEDITOR.config.magicline_keystrokeNext=CKEDITOR.CTRL+CKEDITOR.SHIFT+52;(function(){var f={canUndo:!1,async:!0,exec:function(a,b){var c=a.lang,e=CKEDITOR.tools.keystrokeToString(c.common.keyboard,a.getCommandKeystroke(CKEDITOR.env.ie?a.commands.paste:this)),d=b&&"undefined"!==typeof b.notification?b.notification:!b||!b.from||"keystrokeHandler"===b.from&&CKEDITOR.env.ie,c=d&&"string"===typeof d?d:c.pastetext.pasteNotification.replace(/%1/,'\x3ckbd aria-label\x3d"'+e.aria+'"\x3e'+e.display+"\x3c/kbd\x3e");a.execCommand("paste",{type:"text",notification:d?c:!1})}};CKEDITOR.plugins.add("pastetext",
...
e,null),d&&c&&p(a,d,c)):d&&c&&p(a,d,c)});b.on("dataReady",function(){G(a).commit()});b.on("blur",function(){var b;(b=a.focused)&&x(a,b);(b=a.widgetHoldingFocusedEditable)&&p(a,b,null)})}function O(a){var b=a.editor,c={};b.on("toDataFormat",function(b){var e=CKEDITOR.tools.getNextNumber(),f=[];b.data.downcastingSessionId=e;c[e]=f;b.data.dataValue.forEach(function(b){var c=b.attributes,d;if("data-cke-widget-white-space"in c){d=z(b);var e=A(b);d.parent.attributes["data-cke-white-space-first"]&&(d.value=
d.value.replace(/^&nbsp;/g," "));e.parent.attributes["data-cke-white-space-last"]&&(e.value=e.value.replace(/&nbsp;$/g," "))}if("data-cke-widget-id"in c){if(c=a.instances[c["data-cke-widget-id"]])d=b.getFirst(h.isParserWidgetElement),f.push({wrapper:b,element:d,widget:c,editables:{}}),"1"!=d.attributes["data-cke-widget-keep-attr"]&&delete d.attributes["data-widget"]}else if("data-cke-widget-editable"in c)return 0<f.length&&(f[f.length-1].editables[c["data-cke-widget-editable"]]=b),!1},CKEDITOR.NODE_ELEMENT,
...
f.handle(c()))}function I(a){return(a=(a=a.getDefinition().attributes)&&a["class"])?a.split(/\s+/):null}function K(){var a=CKEDITOR.document.getActive(),b=this.editor,c=b.editable();(c.isInline()?c:b.document.getWindow().getFrame()).equals(a)&&b.focusManager.focus(c)}function L(){CKEDITOR.env.gecko&&this.editor.unlockSelection();CKEDITOR.env.webkit||(this.editor.forceNextSelectionCheck(),this.editor.selectionChange(1))}function V(a,b){ea(a);fa(a);ga(a);ha(a);ia(a);ja(a);ka(a);if(CKEDITOR.env.ie&&
...
na,a),CKEDITOR.env.ie&&9>CKEDITOR.env.version))d.on("dragstart",function(a){a.data.preventDefault(!0)});a.dragHandlerContainer=c}}function na(a){function b(){var b;for(r.reset();b=h.pop();)b.removeListener();var c=k;b=a.sender;var d=this.repository.finder,e=this.repository.liner,f=this.editor,g=this.editor.editable();CKEDITOR.tools.isEmpty(e.visible)||(c=d.getRange(c[0]),this.focus(),f.fire("drop",{dropRange:c,target:c.startContainer}));g.removeClass("cke_widget_dragging");e.hideVisible();f.fire("dragend",
...
CKEDITOR.config.colorButton_foreStyle={element:"span",styles:{color:"#(color)"},overrides:[{element:"font",attributes:{color:null}}]};CKEDITOR.config.colorButton_backStyle={element:"span",styles:{"background-color":"#(color)"}};(function(){function h(a){if(!a||7>=a.length)return!0;a=a.replace(/[\n|\t]*/g,"").toLowerCase();return!a||"<br>"==a||"<p>&nbsp;<br></p>"==a||"<p><br></p>"==a||"<p>&nbsp;</p>"==a||"&nbsp;"==a||" "==a||"&nbsp;<br>"==a||" <br>"==a?!0:!1}function l(a){var b=a.editor,c=b.editable?b.editable():"wysiwyg"==b.mode?b.document&&b.document.getBody():b.textarea,i=a.listenerData;if(c){if("wysiwyg"==b.mode){if(CKEDITOR.dialog._.currentTop||!c)return;h(c.getHtml())&&(c.setHtml(i),c.addClass("placeholder"))}"source"==
b.mode&&(m?"mode"==a.name&&c.setAttribute("placeholder",i):h(c.getValue())&&(c.setValue(i),c.addClass("placeholder")))}}function n(a){var a=a.editor,b=a.editable?a.editable():"wysiwyg"==a.mode?a.document&&a.document.getBody():a.textarea;if(b){if("wysiwyg"==a.mode){if(!b.hasClass("placeholder"))return;b.removeClass("placeholder");if(CKEDITOR.dtd[b.getName()].p){b.setHtml("<p></p>");var c=new CKEDITOR.dom.range(a.document);c.moveToElementEditablePosition(b.getFirst(),!0);a.getSelection().selectRanges([c])}else b.setHtml(" ")}"source"==
a.mode&&b.hasClass("placeholder")&&(b.removeClass("placeholder"),b.setValue(""))}}function o(a){return!a?null:a.getAttribute("lang")||o(a.getParent())}var m="placeholder"in document.createElement("textarea");CKEDITOR.plugins.add("ccmsconfighelper",{getPlaceholderCss:function(){return".placeholder{ color: #999; }"},onLoad:function(){CKEDITOR.addCss&&CKEDITOR.addCss(this.getPlaceholderCss())},init:function(a){a.on("mode",function(a){a.editor.focusManager.hasFocus=!1});var b=a.element.getAttribute("placeholder")||
a.config.placeholder;if(b){a.addCss&&a.addCss(this.getPlaceholderCss());var c=CKEDITOR.document.getHead().append("style");c.setAttribute("type","text/css");CKEDITOR.env.ie&&11>CKEDITOR.env.version?c.$.styleSheet.cssText="textarea.placeholder { color: #999; font-style: italic; }":c.$.innerHTML="textarea.placeholder { color: #999; font-style: italic; }";a.on("getData",function(b){var j=a.editable?a.editable():"wysiwyg"==a.mode?a.document&&a.document.getBody():a.textarea;j&&j.hasClass("placeholder")&&
(b.data.dataValue="")});a.on("setData",function(b){if(!CKEDITOR.dialog._.currentTop&&!("source"==a.mode&&m)){var j=a.editable?a.editable():"wysiwyg"==a.mode?a.document&&a.document.getBody():a.textarea;j&&(h(b.data.dataValue)?l(b):j.hasClass("placeholder")&&j.removeClass("placeholder"))}});a.on("blur",l,null,b);a.on("mode",l,null,b);a.on("focus",n);a.on("beforeModeUnload",n)}if((b=a.config.contentsLanguage||o(a.element))&&!a.config.scayt_sLang)a.config.scayt_sLang={en:"en_US","en-us":"en_US","en-gb":"en_GB",
"pt-br":"pt_BR",da:"da_DK","da-dk":"da_DK","nl-nl":"nl_NL","en-ca":"en_CA","fi-fi":"fi_FI",fr:"fr_FR","fr-fr":"fr_FR","fr-ca":"fr_CA",de:"de_DE","de-de":"de_DE","el-gr":"el_GR",it:"it_IT","it-it":"it_IT","nb-no":"nb_NO",pt:"pt_PT","pt-pt":"pt_PT",es:"es_ES","es-es":"es_ES","sv-se":"sv_SE"}[b.toLowerCase()];var i=function(a){if("object"==typeof a)return a;var a=a.split(";"),b={},c;for(c=0;c<a.length;c++){var d=a[c].split(":");if(3==d.length){var e=d[0],f=d[1],d=d[2];b[e]||(b[e]={});b[e][f]||(b[e][f]=
[]);b[e][f].push(d)}}return b};CKEDITOR.on("dialogDefinition",function(b){if(a==b.editor){var c=b.data.name,b=b.data.definition,g,d,e,f,k;"tableProperties"==c&&"table"==c;!("removeDialogFields"in a._)&&a.config.removeDialogFields&&(a._.removeDialogFields=i(a.config.removeDialogFields));if(a._.removeDialogFields&&(g=a._.removeDialogFields[c]))for(e in g){f=g[e];k=b.getContents(e);for(d=0;d<f.length;d++)k.remove(f[d])}!("hideDialogFields"in a._)&&a.config.hideDialogFields&&(a._.hideDialogFields=i(a.config.hideDialogFields));
if(a._.hideDialogFields&&(g=a._.hideDialogFields[c]))for(e in g){f=g[e];k=b.getContents(e);for(d=0;d<f.length;d++)k.get(f[d]).hidden=!0}if(a.config.dialogFieldsDefaultValues&&(g=a.config.dialogFieldsDefaultValues[c]))for(e in g){f=g[e];k=b.getContents(e);for(var h in f)(c=k.get(h))&&(c["default"]=f[h])}}})}})})();(function(){function m(a){return a?20<a.length?!1:(a=a.replace(/[\n|\t]*/g,"").toLowerCase())&&"\x3cbr\x3e"!=a&&"\x3cp\x3e\x26nbsp;\x3cbr\x3e\x3c/p\x3e"!=a&&"\x3cp\x3e\x3cbr\x3e\x3c/p\x3e"!=a&&"\x3cdiv\x3e\x3cbr\x3e\x3c/div\x3e"!=a&&"\x3cp\x3e\x26nbsp;\x3c/p\x3e"!=a&&"\x26nbsp;"!=a&&" "!=a&&"\x26nbsp;\x3cbr\x3e"!=a&&" \x3cbr\x3e"!=a?!1:!0:!0}function h(a){var c=a.editor;if(!c.readOnly){var b=c.editable(),d=a.listenerData;if(b){if("wysiwyg"==c.mode){if(CKEDITOR.dialog._.currentTop||!b)return;m(b.getHtml())&&
(b.setHtml(d),b.addClass("placeholder"))}"source"==c.mode&&(n?"mode"==a.name&&b.setAttribute("placeholder",d):m(b.getValue())&&(b.setValue(d),b.addClass("placeholder")))}}}function l(a){a=a.editor;var c=a.editable();if(c){if("wysiwyg"==a.mode){if(!c.hasClass("placeholder"))return;c.removeClass("placeholder");if(CKEDITOR.dtd[c.getName()].p){var b="";if(a.enterMode===CKEDITOR.ENTER_P)b="\x3cp\x3e\x3cbr/\x3e\x3c/p\x3e";else if(a.enterMode===CKEDITOR.ENTER_DIV)b="\x3cdiv\x3e\x3cbr/\x3e\x3c/div\x3e";else if(b=
"\x3cbr/\x3e",CKEDITOR.env.gecko||CKEDITOR.env.ie)b=" ";c.setHtml(b);b=new CKEDITOR.dom.range(a.document);b.moveToElementEditablePosition(c.getFirst(),!0);a.getSelection().selectRanges([b])}else c.setHtml(" ")}"source"==a.mode&&c.hasClass("placeholder")&&(c.removeClass("placeholder"),c.setValue(""))}}function r(a){a.editor.readOnly?l(a):h(a)}function p(a){return a?a.getAttribute("lang")||p(a.getParent()):null}var n="placeholder"in document.createElement("textarea");CKEDITOR.plugins.add("confighelper",
{getPlaceholderCss:function(){return".placeholder{ color: #999; }"},onLoad:function(){CKEDITOR.addCss(this.getPlaceholderCss())},init:function(a){function c(b){if(a==b.editor){var k=b.data.name;b=b.data.definition;var c,e,f,g,d;"tableProperties"==k&&(k="table");"removeDialogFields"in a._||!a.config.removeDialogFields||(a._.removeDialogFields=q(a.config.removeDialogFields));if(a._.removeDialogFields&&(c=a._.removeDialogFields[k]))for(f in c)if(g=c[f],d=b.getContents(f))for(e=0;e<g.length;e++)d.remove(g[e]);
"hideDialogFields"in a._||!a.config.hideDialogFields||(a._.hideDialogFields=q(a.config.hideDialogFields));if(a._.hideDialogFields&&(c=a._.hideDialogFields[k]))for(f in c)if(g=c[f],d=b.getContents(f))for(e=0;e<g.length;e++)d.get(g[e]).hidden=!0;if(a.config.dialogFieldsDefaultValues&&(c=a.config.dialogFieldsDefaultValues[k]))for(f in c)if(g=c[f],d=b.getContents(f))for(var h in g)(k=d.get(h))&&(k["default"]=g[h])}}a.on("mode",function(a){a.editor.focusManager.hasFocus=!1});var b=a.element.getAttribute("placeholder")||
a.config.placeholder;if(b){var d=CKEDITOR.document.getHead().append("style");d.setAttribute("type","text/css");CKEDITOR.env.ie&&11>CKEDITOR.env.version?d.$.styleSheet.cssText="textarea.placeholder { color: #999; font-style: italic; }":d.$.innerHTML="textarea.placeholder { color: #999; font-style: italic; }";a.on("getData",function(b){var c=a.editable();c&&c.hasClass("placeholder")&&(b.data.dataValue="")});a.on("setData",function(b){if(!(CKEDITOR.dialog._.currentTop||"source"==a.mode&&n)){var c=a.editable();
c&&(m(b.data.dataValue)?h(b):c.hasClass("placeholder")&&c.removeClass("placeholder"))}});a.on("blur",h,null,b);a.on("mode",h,null,b);a.on("contentDom",h,null,b);a.on("focus",l);a.on("key",l);a.on("beforeModeUnload",l);a.on("readOnly",r,null,b)}if((b=a.config.contentsLanguage||p(a.element))&&a.plugins.scayt&&!a.config.scayt_sLang){try{localStorage&&localStorage.removeItem("scayt_0_lang")}catch(t){}a.config.scayt_sLang={en:"en_US","en-us":"en_US","en-gb":"en_GB","pt-br":"pt_BR",da:"da_DK","da-dk":"da_DK",
"nl-nl":"nl_NL","en-ca":"en_CA","fi-fi":"fi_FI",fr:"fr_FR","fr-fr":"fr_FR","fr-ca":"fr_CA",de:"de_DE","de-de":"de_DE","el-gr":"el_GR",it:"it_IT","it-it":"it_IT","nb-no":"nb_NO",pt:"pt_PT","pt-pt":"pt_PT",es:"es_ES","es-es":"es_ES","sv-se":"sv_SE"}[b.toLowerCase()]}var q=function(a){if("object"==typeof a)return a;a=a.split(";");var b={},c;for(c=0;c<a.length;c++){var e=a[c].split(":");if(3==e.length){var f=e[0],d=e[1],e=e[2];b[f]||(b[f]={});b[f][d]||(b[f][d]=[]);b[f][d].push(e)}}return b};CKEDITOR.on("dialogDefinition",
c);a.once("beforeDestroy",function(){CKEDITOR.removeListener("dialogDefinition",c)})}})})();(function(){function m(a){function e(a){var b=!1;g.attachListener(g,"keydown",function(){var d=c.getBody().getElementsByTag(a);if(!b){for(var f=0;f<d.count();f++)d.getItem(f).setCustomData("retain",!0);b=!0}},null,null,1);g.attachListener(g,"keyup",function(){var d=c.getElementsByTag(a);b&&(1==d.count()&&!d.getItem(0).getCustomData("retain")&&CKEDITOR.tools.isEmpty(d.getItem(0).getAttributes())&&d.getItem(0).remove(1),b=!1)})}var b=this.editor;if(b&&!b.isDetached()){var c=a.document,d=c.body,f=c.getElementById("cke_actscrpt");
...
CKEDITOR.on("dialogDefinition",function(e){var g=e.data.definition;if("docProps"==e.data.name){var f=function(b,c,d){b.removeStyle(c);b.getComputedStyle(c)!=d&&b.setStyle(c,d)};e=g.getContents("design");e.add({type:"text",label:"Comma-separated list of fonts",title:"The browser will use the first font available, left-to-right.  Enter your top choice first, and include a fallback of either 'sans serif' or 'serif' as your final entry.",id:"font",setup:function(b,c,d,a){this.setValue(a.getStyle("font-family")||
a.getAttribute("font-family")||"")},commit:function(b,c,d,a){a.removeAttribute("font-family");(b=this.getValue())?a.setStyle("font-family",b):f(a,"font-family","none")}});e.add({type:"text",label:"Font size (e.g., 92%, .92em, 11pt, 14px)",title:"Generally % gives best results; em is a good second choice.  Typically 100% \x3d 1em \x3d 12pt \x3d 16px.",id:"fontSize",setup:function(b,c,d,a){this.setValue(a.getStyle("font-size")||a.getAttribute("font-size")||"")},commit:function(b,c,d,a){a.removeAttribute("font-size");
(b=this.getValue())?a.setStyle("font-size",b):f(a,"font-size","none")}});e.add({type:"text",label:"Line height (space between lines, e.g., 150%, 1.5em, 1.5)",title:"Typically 100% \x3d 1em \x3d 1.",id:"lineHeight",setup:function(b,c,d,a){this.setValue(a.getStyle("line-height")||a.getAttribute("line-height")||"")},commit:function(b,c,d,a){a.removeAttribute("font-size");(b=this.getValue())?a.setStyle("line-height",b):f(a,"line-height","none")}})}});(function(){function b(a,b,d){this.editor=a;this.lastMatched=null;this.ignoreNext=!1;this.callback=b;this.ignoredKeys=[16,17,18,91,35,36,37,38,39,40,33,34];this._listeners=[];this.throttle=d||0;this._buffer=CKEDITOR.tools.throttle(this.throttle,function(a){(a=this.callback(a))?a.text!=this.lastMatched&&(this.lastMatched=a.text,this.fire("matched",a)):this.lastMatched&&this.unmatch()},this)}CKEDITOR.plugins.add("textwatcher",{});b.prototype={attach:function(){function a(){var a=c.editable();this._listeners.push(a.attachListener(a,
