        ...
        if (target) {
          ...
          evt.detail.shouldSwap = true
            /* The extension re-targets the response, which is an error message,
               to some other location on the page identified by a selector. This
               is mostly to handle a POST from something like a button that
               returned an error. The error can then be shown in a designated
