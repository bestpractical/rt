...
$pg2 = RT::Model::Group->new(RT->system_user);
...
ok( not( $pg1->PrincipalObj->has_right(
            Right  => 'AdminGroup',
            Object => $pg1 )),
