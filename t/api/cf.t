...
my $object_cfs = RT::Model::ObjectCustomFieldCollection->new(RT->system_user);
...
my $queue2 = RT::Model::Queue->new( RT->system_user );
...
my $local_cf1 = RT::Model::CustomField->new( RT->system_user );
...
my $local_cf2 = RT::Model::CustomField->new( RT->system_user );
...
my $global_cf3 = RT::Model::CustomField->new( RT->system_user );
...
my $local_cf4 = RT::Model::CustomField->new( RT->system_user );
