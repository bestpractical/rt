...

{
    ...
    warning_like { RT::Date::WeekStartDate( $user, $date, 'foo' ) }
    ...
    my ($ret, $start) = RT::Date::WeekStartDate($user, $date, 'Monday');
    ...
    ($ret, $start) = RT::Date::WeekStartDate($user, $date, 'Monday');
    ...
    $date->Set(Format => 'unknown', Value => '2014-01-14 00:00:00', Timezone => 'user' );
    ($ret, $start) = RT::Date::WeekStartDate($user, $date);
    is( $start->ISO( Timezone => 'user'), '2014-01-13 00:00:00', "Got Monday as default when passing Tuesday");

    # same tests using utc timezone
    $date->Set(Format => 'unknown', Value => '2014-01-12 00:00:00', Timezone => 'utc' );
    ($ret, $start) = RT::Date::WeekStartDate($user, $date, 'Monday', 'utc');
    is( $start->ISO( Timezone => 'utc'), '2014-01-06 00:00:00', "Got the previous Monday when passing Sunday");

    $date->Set(Format => 'unknown', Value => '2014-01-13 00:00:00', Timezone => 'utc' );
    ($ret, $start) = RT::Date::WeekStartDate($user, $date, 'Monday', 'utc');
    is( $start->ISO( Timezone => 'utc'), '2014-01-13 00:00:00', "Got Monday when passing Monday");

    $date->Set(Format => 'unknown', Value => '2014-01-14 00:00:00', Timezone => 'utc' );
    ($ret, $start) = RT::Date::WeekStartDate($user, $date, 'Monday', 'utc');
    is( $start->ISO( Timezone => 'utc'), '2014-01-13 00:00:00', "Got Monday when passing Tuesday");

    $date->Set(Format => 'unknown', Value => '2014-01-14 00:00:00', Timezone => 'utc' );
    ($ret, $start) = RT::Date::WeekStartDate($user, $date, undef, 'utc');
    is( $start->ISO( Timezone => 'utc'), '2014-01-13 00:00:00', "Got Monday as default when passing Tuesday");
}
