...
my $cf2 = RT::Model::CustomField->new(RT->system_user);
...
my $cf3 = RT::Model::CustomField->new(RT->system_user);
...
my $t4 = RT::Model::Ticket->new(RT->system_user);
...
my $t5 = RT::Model::Ticket->new(RT->system_user);
...
my $t6 = RT::Model::Ticket->new(RT->system_user);
...
my $t7 = RT::Model::Ticket->new(RT->system_user);
...
$tix = RT::Model::TicketCollection->new(RT->system_user);
