...
sub cli_show_req {
    ...
    print "             Created:". &ctime($rt::req[$in_serial_num]{'date_created'})."";
    print "   Last User Contact:".&ctime($rt::req[$in_serial_num]{'date_told'})."";
    print "        Last Contact:$rt::req[$in_serial_num]{'since_told'}\n";
    print "                 Due:".&ctime($rt::req[$in_serial_num]{'date_due'})."";
