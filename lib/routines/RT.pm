...
############################################################
# you should not need to futz with anything below this line#
############################################################
    $rtversion="0.9.0";
...
#
# In lots of cases (the web) we don't know who the user is when we're invoked
#

#    if (!&is_a_user($in_current_user)) {
#	return (0,"You are not authorized to work with RT.");
#    }
#    else {
