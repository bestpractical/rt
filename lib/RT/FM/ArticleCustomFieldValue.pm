...
package RT::FM::ArticleCustomFieldValue;
use RT::FM::Record; 
use RT::FM::Content;
...
sub _ClassAccessible {
    {
        ...
        eval "require RT::FM::ArticleCustomFieldValue_Overlay";
        if ($@ && $@ !~ /^Can't locate/) {
            die $@;
        };

        eval "require RT::FM::ArticleCustomFieldValue_Local";
        if ($@ && $@ !~ /^Can't locate/) {
            die $@;
        };
...
RT::FM::ArticleCustomFieldValue_Overlay, RT::FM::ArticleCustomFieldValue_Local
