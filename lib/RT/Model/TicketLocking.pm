...
sub Unlock {
    ...
    my $lock = $ticket->RT::Model::Ticket::Locked();
...
sub BreakLock {
    my $ticket = shift;
    return $ticket->delete_attribute('RT_Lock');
}
