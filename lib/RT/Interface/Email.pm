# $Header: /raid/cvsroot/rt/lib/RT/Interface/Email.pm,v 1.2 2001/11/06 23:04:52 jesse Exp $
...
sub ParseMIMEEntity {
    ...
    my $entity;
    unless ($entity = $parser->parse_data(shift)) {
...
sub Gateway {
    ...
    unless ($QueueObj->id ) {
        ...
        MailError(To => $RT::OwnerEmail,
                  ...
                  MIMEObj => $Item);
        return (0, "RT couldn't find the queue: $Queue");
    }
    ...
    if ($IsALoop) {
        ...
        return (0, "Bounce") unless ($RT::StoreLoops);
        }
    }
   ...
   #Don't let the user stuff the RT-Squelch-Replies-To header.
    ...
    if (!defined($TicketId)) {
        ...
        my ($id, $Transaction, $ErrStr) =
          $Ticket->Create ( Queue => $Queue,
            ...
            if ($id == 0 ) {
                ...
                return (0, "Ticket creation failed");
            }
        }
        ...
        $RT::Logger->crit("$Action aliases require a TicketId to work on ".
                  ...
                  $MessageId);
        return (0, "$Action aliases require a TicketId to work on");
        }
    }
    # }}}
        ...
        unless ($status) {
            ...
            return (0, "Correspondence not recorded");
        }
        }
        ...
        $RT::Logger->crit("$Action type unknown for $MessageId");
            return (0, "Configuration error: $Action not a recognized action");
